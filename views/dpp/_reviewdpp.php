...
<table width="100%">
    <tr>
        ...
        <td width="50%" style="text-align:center">Gresik, <?= ($template->tgl_dikembalikan !== "" || $template->tgl_dikembalikan !== null) ? Yii::$app->formatter->asDate(($historyreject->tgl_dikembalikan ?? ($template->tgl_dikembalikan ?? date('Y-m-d'))), 'php:d F Y') : ' ...... ' ?><br>
