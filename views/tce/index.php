...
use yii2ajaxcrud\ajaxcrud\BulkButtonWidget;$idmodal = $searchModel->hash;$this->title = 'Template Checklist Evaluasi';
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['tce/create'],
                        ['role' => 'modal-remote', 'data-target' => '#' . $idmodal, 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Template Checklist Evaluasis', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
