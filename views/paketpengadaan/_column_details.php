...
return [
                    ...
                    [
                        ...
                        'value'=>function($d)use($idmodelpenawaran){
                            return Html::a(Yii::$app->formatter->asCurrency($d->penawaran)??'#',['/paketpengadaan/postpenawaran','id'=>$d->id],['role' => 'modal-remote','data-pjax' => '0','data-target'=>'#'.$idmodelpenawaran,'title' => Yii::t('yii2-ajaxcrud', 'Penawaran')]);
                        },
                    ],
                    [
                        'attribute'=>'negosiasi',
                        ...
                        'value'=>function($d)use($idmodelnego){
                            return Html::a(Yii::$app->formatter->asCurrency($d->negosiasi)??'#',['/paketpengadaan/negoproduk','id'=>$d->id],['role' => 'modal-remote','data-pjax' => '0','data-target'=>'#'.$idmodelnego,'title' => Yii::t('yii2-ajaxcrud', 'Nego')]);
                        },
                    ],
                    [
                        'attribute'=>'totalhps',
