...
/* @var $searchModel app\models\PeralatanKerjaSearch */

$this->title = 'Peralatankerja';
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Peralatankerjas', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
