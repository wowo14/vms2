...
use yii2ajaxcrud\ajaxcrud\BulkButtonWidget;$idmodal = $searchModel->hash;$this->title = 'Template Checklist Evaluasi Detail';
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['tced/create'],
                        ['role' => 'modal-remote', 'data-target' => '#' . $idmodal, 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Template Checklist Evaluasi Details', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
