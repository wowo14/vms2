...
/* @var $searchModel app\models\StaffAhliSearch */

$this->title = 'Staff Ahli';
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['create'],
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Staff Ahlis', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
