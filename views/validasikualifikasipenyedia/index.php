            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['validasikualifikasipenyedia/create'],
                        ['role' => 'modal-remote','data-target' => '#' . $idmodal, 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Validasi Kualifikasi Penyedias', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
