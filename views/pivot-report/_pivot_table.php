...
$bulan = '';
if (isset($model->bulan_awal) && isset($model->bulan_akhir) 
...
$isMultiSum = isset($keys['sumField']);
    ...
    <?php else: ?>
        <tr class="table-secondary">
            ...
            foreach ($bulanRange as $bulanNum => $bulanLabel) {
                ...
                echo '<th class="text-right">'.$totalPerBulan[$bulanNum].'</th>';
            }
            $grandTotal = array_sum($totalPerBulan);
            echo '<th class="text-right"><strong>'.
            $grandTotal
            .'</strong></th>';
            ?>
        </tr>
