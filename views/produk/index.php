...
use yii2ajaxcrud\ajaxcrud\BulkButtonWidget;$idmodal = $searchModel->hash;$this->title = 'Produk';
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['produk/create'],
                        ['role' => 'modal-remote', 'data-target' => '#' . $idmodal, 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Produks', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
