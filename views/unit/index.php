...
use yii2ajaxcrud\ajaxcrud\BulkButtonWidget;$idmodal = $searchModel->hash;$this->title = 'Unit';
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['unit/create'],
                        ['role' => 'modal-remote', 'data-target' => '#' . $idmodal, 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Units', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
