...
$js = <<< JS
function rabid(){
    var programnya=$('#rab-kode_program').find(':selected').text().split('- ').pop();
    var kegiatannya=$('#rab-kode_kegiatan').find(':selected').text().split('- ').pop();
    var rekeningnya=$('#rab-kode_rekening').find(':selected').text().split('- ').pop();
    if(programnya && programnya.trim() !== ''){
        $('#rab-nama_program').val(programnya);
    }
    if(kegiatannya && kegiatannya.trim() !== ''){
        $('#rab-nama_kegiatan').val(kegiatannya);
    }
    if(rekeningnya && rekeningnya.trim() !== ''){
        $('#rab-uraian_anggaran').val(rekeningnya);
    }
}
JS;
