...
use app\models\PeralatanKerjaSearch;
use yii\web\{Response, NotFoundHttpException};
use yii\filters\VerbFilter;
use yii\helpers\Html;class PeralatankerjaController extends Controller {
    ...
    public function actionIndex() {
        $searchModel = new PeralatanKerjaSearch();
        ...
        if ($request->isAjax) {            Yii::$app->response->format = Response::FORMAT_JSON;
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New') . " Peralatankerja",
                    'content' => '<span class="text-success">' . Yii::t('yii2-ajaxcrud', 'Create') . ' Peralatankerja ' . Yii::t('yii2-ajaxcrud', 'Success') . '</span>',
                    'footer' =>  Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class' => 'btn btn-default pull-left', 'data-dismiss' => 'modal']) .
    ...
    protected function findModel($id) {
        if (($model = Peralatankerja::findOne($id)) !== null) {
            return $model;
        } else {
