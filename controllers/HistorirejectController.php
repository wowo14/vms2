...
use app\models\HistoriRejectSearch;
use yii\web\Controller;
use yii\web\{Response,NotFoundHttpException};
use yii\filters\VerbFilter;
use yii\helpers\Html;
class HistorirejectController extends Controller
{
    ...
    {
        $searchModel = new HistoriRejectSearch();
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New')." HistoriReject",
                    'content' => '<span class="text-success">'.Yii::t('yii2-ajaxcrud', 'Create').' HistoriReject '.Yii::t('yii2-ajaxcrud', 'Success').'</span>',
                    'footer' =>  Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class' => 'btn btn-default pull-left', 'data-dismiss' => 'modal']).
    ...
    {
        if (($model = HistoriReject::findOne($id)) !== null)
        {
            return $model;
        }else{
